...
V8_EXPORT v8::Isolate *CreateJSEngine(int backend, bool jitless)
{
#if WITH_QUICKJS
...
V8_EXPORT v8::Isolate *CreateJSEngineWithExternalEnv(int backend, void* external_quickjs_runtime, void* external_quickjs_context, bool jitless)
{
#if WITH_QUICKJS
